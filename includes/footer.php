    ...
    <footer>
                ...
                <h2 class="brand"><a href="index.php"> Content<span style="color: #ff591cbb">Management</span>Tool </a></h2>
...
setInterval(GetClock,1000);
                ...
                <p class="footer-terms">Copyright &copy; <script>document.write(new Date().getFullYear())</script>Content Management Tool. All right reserved</p>
              </footer>